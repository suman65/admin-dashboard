...
folder are mapped to the application's root namespace, 'Admin.dashboard'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Admin.dashboard' in the same way
as `"Admin.dashboard/sass/src"`.
